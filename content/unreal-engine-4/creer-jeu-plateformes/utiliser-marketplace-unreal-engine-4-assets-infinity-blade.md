...
*   **Le workflow d'importation :** La gestion des assets via le Launcher Epic Games reste le standard pour intégrer du contenu tiers.
*   **Analyse des matériaux :** Les packs *Infinity Blade* sont toujours d'excellents exemples pour étudier les "Master Materials" et l'utilisation des textures de normales (Normal Maps) pour donner du relief aux objets.
